            ...
            <div class="card">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="javascript:void(0);" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#orderModal" 
                        data-id="{{ $product->id }}" 
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        quantityInput.addEventListener('input', (event) => {
            ...
            const pricePerUnit = parseInt(document.getElementById('product_price').textContent, 10);
            totalPriceSpan.textContent = quantity * pricePerUnit;
        });
    });
</script>
