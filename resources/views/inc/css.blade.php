    ...
    <!-- Favicon -->
     <link rel="icon" type="image/x-icon" href="{{ asset('app-assets/assets/img/favicon/favicon.ico')}}" />
    ...
    <link rel="stylesheet" href="{{ asset('app-assets/assets/vendor/libs/apex-charts/apex-charts.css') }}" />
    <!-- Toastr CSS -->
